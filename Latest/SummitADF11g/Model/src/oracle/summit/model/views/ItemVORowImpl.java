...
//        //If the filename doesn't end with a TIF file extension (no file) add one
//        if (!ret.toString().endsWith(TIF_EXTENSION)) {
//            return ret.toString() + JPG_EXTENSION;
//        } else
//            //replace TIF with JPG
//            return ret.toString().replaceAll(TIF_EXTENSION, JPG_EXTENSION);
    }
